...
select * from dbo.QC_ISSUES_POI_PT
-- Create a table of issues
-- drop table QC_ISSUES_POI_PT_for_owner_on_date
-- select * into QC_ISSUES_POI_PT_for_owner_on_date from dbo.QC_ISSUES_POI_PT
select * from dbo.QC_ISSUES_POI_LN
-- Create a table of issues
-- drop table QC_ISSUES_POI_LN_for_owner_on_date
-- select * into QC_ISSUES_POI_LN_for_owner_on_date from dbo.QC_ISSUES_POI_LN
select * from dbo.QC_ISSUES_POI_PY
-- Create a table of issues
-- drop table QC_ISSUES_POI_PY_for_owner_on_date
-- select * into QC_ISSUES_POI_PY_for_owner_on_date from dbo.QC_ISSUES_POI_PY
