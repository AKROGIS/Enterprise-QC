...
-- POIs with broken links to buildings in akr_facilities (159 of 2512)
...
-- Compare POIs with buildings (2313)
...
-- Compare Location (317 issues, 54 significant)
...
-- POIs with broken links to trail feature points in akr_facilities (59 out of 271)
select p.FEATUREID, p.MAPLABEL from akr_socio.gis.POI_PT as p
