...
-- Step 1) Import the FMSS export CSVs into tables
...
-- Step 2) delete bogus records required to get CSV import to work
...
-- Step 6a) Fix the permissions for Locations
...
-- Step 6b) Fix the permissions for assets
